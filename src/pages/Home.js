  ...
  return (
    <div className="min-h-screen p-4 md:p-8">
      ...
      <main className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Card 4 - Valentine Card Generator */}
        <Link to="/valentine" className="retro-card p-5 pixel-corners">
          <div className="flex justify-between items-start mb-3">
            <h2 className="text-2xl font-bold">Valentine Card</h2>
          </div>
          <div className="mb-4 h-40 bg-primary/10 flex items-center justify-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="text-lg">Create Valentine cards where they cant say no</p>
        </Link>
